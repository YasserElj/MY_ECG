#!/bin/bash
#SBATCH --job-name=myjepa-diagnostic
#SBATCH --output=outputs/finetune_diagnostic_%j.log
#SBATCH --error=errors/finetune_diagnostic_%j.err
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:1
...
echo "Diagnostic finetuning completed!"
