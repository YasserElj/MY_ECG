#!/bin/bash
#SBATCH --job-name=myjepa-superdiag
#SBATCH --output=outputs/finetune_superdiag_%j.log
#SBATCH --error=errors/finetune_superdiag_%j.err
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:1
...
echo "Superdiagnostic finetuning completed!"
