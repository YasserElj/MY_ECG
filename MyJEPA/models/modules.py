"""Core building blocks for MyJEPA models."""
...
class PatchEmbedding(nn.Module):
    """1D patch embedding using convolution."""
...
class Projector(nn.Module):
    """MLP projector for SIGReg with BatchNorm."""
...
class CrossAttention(nn.Module):
    """Cross-attention for AttentivePooler."""
...
class AttentivePooler(nn.Module):
    """Attentive pooling using learnable query tokens."""
